...
VALUES
  ...
  ('Rewards', 'View rewards', 'rewards.view', '/api/rewards', 'POST', 'List rewards and open reward details.'),
  ('Rewards', 'Create rewards', 'rewards.create', '/api/rewards/create', 'POST', 'Create game reward records.'),
...
CREATE TABLE IF NOT EXISTS games (
  ...
  is_mobile VARCHAR(10) NOT NULL DEFAULT 'False',
...
ALTER TABLE games
  ...
  ADD COLUMN IF NOT EXISTS is_mobile VARCHAR(10) NOT NULL DEFAULT 'False',
...
ALTER TABLE games
  ...
  MODIFY COLUMN is_mobile VARCHAR(10) NOT NULL DEFAULT 'False';
